...
export default function ProductCard({ title, category, slug, imgSrc, price, size }: PropsTypes) {
  return (
    ...
    <Link href={slug} className="group transition-all border  rounded-md px-2 py-2 flex flex-col  hover:shadow-lg">       
        <div style={{
          position:"relative",
          height: 250,
          // width:280
        ...
        <h3 className="mt-3 text-sm text-gray-700 truncate">{title}</h3>
