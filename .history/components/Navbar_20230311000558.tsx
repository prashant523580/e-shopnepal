    ...
    return (
      <>
        ...
        <div className="relative sm:w-64 w-40 space-y-5 sm:mr-4 mr-2">
          ...
          <input type="text" id="footer-field" placeholder='search for products' name="search" className="w-full bg-gray-100 bg-opacity-50 rounded focus:ring-2 focus:bg-transparent focus:border-indigo-500 text-base outline-none text-white py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
        </div>
