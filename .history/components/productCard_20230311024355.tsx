        ...
        className="aspect-w-1 border-b  aspect-h-1 w-full  overflow-hidden rounded-lg  bg-gray-200 xl:aspect-w-7 xl:aspect-h-8"
         >
          <Image fill sizes="100vw"
           ...
           />
          <p className=" absolute left-2 top-2 bg-gray-400 opacity-40 rounded-2xl px-2  text-lg font-medium text-white">{brand}</p>
          <p className=" absolute bottom-2 right-2 bg-orange-400 rounded-2xl px-2  text-lg font-medium text-white">Rs.{price}</p>
        </div>
        <div className='px-2'>
