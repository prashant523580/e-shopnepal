    ...
    return (
      <>
        ...
        <div className="relative sm:w-64 w-40 space-y-5 sm:mr-4 mr-2">
          ...
          <input type="text" id="footer-field" placeholder='search for products' name="search" className="w-full bg-white bg-opacity-30 rounded focus:ring-2 focus:bg-transparent  text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
        </div>
