...
export default function ProductCard({ title, category, slug, imgSrc, price, size,addToCart ,brand ,items }: PropsTypes) {
  return (

    items ?    <div className="transition-all rounded-md flex flex-col">
