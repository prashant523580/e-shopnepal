...
export default function All(props: any) {
    ...
    return (
        <section className='flex justify-between'>
            <div className='w-[25%] sm:px-1 md:px-2 lg:px-3 xl:px-5 h-[100vh] bg-gray-300 sticky top-10' >
            ...
            <div className='w-[70%] h-[100vh] overflow-y-auto bg-gray-300 rounded-3xl shadow-xl' >
