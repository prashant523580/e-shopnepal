...
export default function ProductSlug(props: any) {
  ...
  const [product] = React.useState<any>(props.products.products);
        ...
        <div className="lg:w-5/5 mx-auto  flex  flex-wrap">
          <div className="img block relative ">
            <Image priority
              ...
              className="lg:w-1/2 w-full lg:h-auto px-4 object-cover object-center rounded"
              src={product.imgSrc} />
              ...
              <div className="flex ml-6 items-center">
                ...
                <div className="relative">
                  <select className="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base pl-3 pr-10">
                    {
                      product.size.map((si: any, ind: any) => {
                        return (
                          <option key={ind} value={si}>{si}</option>
            ...
            <div className="flex justify-between flex-wrap">
              ...
              <div className="flex justify-end items-center space-x-2">
                <Link href={"/checkout"}>
                  ...
                  <Button className="flex ml-auto text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded font-bold capitalize">Buy</Button>
                </Link>
                <Button
                  onClick={addCart}
