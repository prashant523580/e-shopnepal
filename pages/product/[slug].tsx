      ...
      <div className="container px-4 py-6 mx-auto">
        {
          ...
          <div role="status" className="space-y-8 animate-pulse md:space-y-0 md:space-x-8 md:flex md:items-center">
              <div className="flex items-center justify-center w-full h-60 bg-gray-300 rounded sm:w-full dark:bg-gray-700">
        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            width={100}
            height={100}
            className='lg:w-1/2 w-full lg:h-auto  object-top rounded object-contain'
            src={product.imgSrc} 
            priority
            />
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2  mb-5">
              <div className="flex">
                ...
                {Object.keys(varients).includes("pink") && Object.keys(varients["pink"]).includes(size) && <button onClick={() => getProductByVarient("pink",size)}  style={{background: "pink"}} className={`border-2 mx-1 rounded-full w-6 h-6 focus:outline-none`}></button>}
