    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 mx-auto flex flex-wrap flex-col">
        ...
        >
          ...
          {props.user.value ? <h1>user  address</h1>
            :
        ...
        <>
          ...
          <div className="w-2/2 flex justify-center items-center">
            ...
            <div className="relative mb-4 w-full ml-2">
        ...
        >
          ...
          <div className='py-4'>
            {/* <Link href="/orderComplete"> */}
              ...
              {/* <Button onClick={submitOrder} className='bg-orange-500 text-white hover:bg-orange-600 font-bold'>Pay Rs.{props.subTotal}</Button> */}
            {/* </Link> */}
          </div>
        </CheckoutComponent>
